...
export default function FixedMenu({ setIsDrawerOpen }: FixedMenuProps) {
  return (
    <div className={styles.menu}>
      <ul className={styles.list}>
        <li className={styles.item}>
          <button
            type="button"
            className={`${styles.drawerButton} ${styles.btn}`}
